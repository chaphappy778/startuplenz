    ...
    <main className="prose-page">
      <header className="prose-page-header">
        ...
        <p className="prose-page-lede">
          ...
          drifted out from under them. StartupLenz works differently &mdash;
          the data behind every model lives in a database, evolves as the
      ...
      <article className="prose">
        <section>
          ...
          <p>
            Every vertical&rsquo;s default values &mdash; platform fees,
            average shipping cost per order, channel mix percentages,
            industry margin benchmarks, materials cost ranges &mdash; lives
          ...
          <p>
            ...
            content management tools, the publishing pipeline &mdash; so
            the calculators can keep up with the markets they describe.
        ...
        <section>
          ...
          <p>
            <strong>Public marketplace data.</strong> Platform fees, payment-
            processor rates, marketplace conversion benchmarks, average
            shipping costs by region &mdash; these are observable from
            official fee schedules (Etsy, TikTok Shop, Shopify, Stripe)
            and from public commerce reports. This is the most precise
            kind of input. When a fee changes, the update is mechanical.
          </p>
          <p>
            <strong>Public operator content.</strong> Indie founders share
            an enormous amount in public &mdash; podcast appearances,
            YouTube channels, founder threads on X and Reddit, AMAs, blog
            posts. We synthesize from those when we&rsquo;re building or
            updating a vertical. When five different slime founders
            independently mention heat-pack costs as a real summer line
            item, that&rsquo;s a signal that the field belongs in the
            model. We don&rsquo;t run private interviews &mdash; we work
            from what operators have already put into the world in their
            own words.
          </p>
          <p>
            <strong>Industry reports and trade publications.</strong> For
            inputs that aren&rsquo;t directly observable &mdash; labor
            minutes per unit for a handmade candle, customer churn for a
            subscription box at the indie tier &mdash; we triangulate from
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Channel-aware revenue.</strong> If you sell on Etsy,
              TikTok Shop, and your own site, each channel has different
              fees, different average order value, and different conversion.
              We model the split as a percentage allocation across channels
              rather than averaging them out. The own-site channel uses
              standard card-processing (~2.9% + $0.30) &mdash; built-in,
              not a slider &mdash; so you can&rsquo;t forget it.
            </li>
            <li>
            ...
            <li>
              <strong>Labor.</strong> Labor minutes per unit times an hourly
              rate &mdash; including your own time. Most calculators skip
              this and the founder ends up working for $4/hr without
              realizing it.
            </li>
            <li>
              <strong>Marketing &amp; gifting.</strong> Where applicable, a
              monthly ad / influencer-gifting budget gets subtracted from
              net profit. Not a separate CAC metric, just a real cost-of-
              business line.
            </li>
            <li>
              <strong>Subscription dynamics (where relevant).</strong> For
              subscription-box and recurring-revenue verticals, monthly
          ...
          <p>
            ...
            handle is the math, the fees, and the channel allocation &mdash;
            with defaults that stay current to the market.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The launch &rarr; traction &rarr; scale chart projects net
            ...
            It&rsquo;s not a regression from your sliders &mdash; it&rsquo;s
          ...
          <p>
            ...
            that the business pencils out &mdash; you just have to survive
            the early phases. If scale is still below break-even, the math
        ...
        <section>
          ...
          <p>
            ...
            discounting. The library is hand-curated &mdash; the model
        ...
        <section>
          ...
          <p>
            ...
            tells you exactly what each lever needs to change to &mdash;
            not just a vague &ldquo;raise price and reduce cost.&rdquo;
          </p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Taxes.</strong> Self-employment tax, sales tax nexus,
              quarterly estimates. Talk to an accountant for these.
            </li>
            <li>
              <strong>Returns and refunds.</strong> We compute net profit
              before returns. Build in a returns-reserve assumption if your
              category has high return rates (apparel).
            </li>
            <li>
              <strong>Brand-building time horizon.</strong> The first 6
              months of a business are usually loss-making while you build
              the audience. Our model doesn&rsquo;t pretend otherwise
              &mdash; the launch phase is intentionally lower than scale
              &mdash; but we don&rsquo;t model the morale tax of working
              for free.
            </li>
            <li>
              <strong>Working capital.</strong> If you need $5k of materials
              on hand to fulfill orders, the cash-flow timing of that
              isn&rsquo;t modeled. P&amp;L profitability and cash-positive
              are different things.
            </li>
            <li>
              <strong>Personal expenses.</strong> The calculator tells you
              what the business produces, not whether that&rsquo;s enough
              for you to live on. Multiply your tax-adjusted net profit by
              0.7&ndash;0.8 to get a rough take-home.
            </li>
          </ul>
        </section>
